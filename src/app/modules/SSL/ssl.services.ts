...
const initPayment = async (appointmentData: IAppointmentData) => {
  const data = {
    ...
    total_amount: 100,
    currency: "BDT",
    tran_id: appointmentData.transection_id, // use unique tran_id for each api call
    ...
    product_profile: "N/A",
    cus_name: appointmentData.patient_name,
    cus_email: appointmentData.patient_email,
    cus_add1: appointmentData.patient_add1,
    cus_add2: "N/A",
    cus_city: "N/A",
    cus_state: "N/A",
    cus_postcode: "N/A",
    cus_country: "Bangladesh",
    cus_phone: appointmentData.phone_number,
    cus_fax: "N/A",
    ship_name: "N/A",
    ship_add1: "N/A",
    ship_add2: "N/A",
